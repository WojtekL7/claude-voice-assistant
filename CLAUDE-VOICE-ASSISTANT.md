...
## AKTUALNY STAN (wersja 1.0.24 — WYDANA, 3 platformy)
...
## Inne otwarte TODO
- [x] ~~**1.0.24 — POTWIERDZIĆ u usera**~~ POTWIERDZONE + WYDANE 3-platformowo (2026-06-26, appcast 1.0.24, commit `8c17f7c`). **Otwarta obserwacja (do ew. zrobienia):** PRZEWIJANIE w Claude (B1 zabiera mysz w oknie Claude; kółko działa) — jeśli zacznie przeszkadzać userowi → zrobić PRZEŁĄCZNIK „tryb zaznaczania" zamiast always-on.
