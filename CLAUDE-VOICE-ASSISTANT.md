...
> **Wydania NIE było** (decyzja usera) — zmiany w aplikacji/instalatorze wejdą do **1.0.14**.
> Strony WWW już wdrożone na VPS (działają niezależnie od wersji aplikacji).
