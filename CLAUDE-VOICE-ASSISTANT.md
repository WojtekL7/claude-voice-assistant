...
**Zużycie:** Opus 5 = ta sama cena za token co 4.8, ale **domyślnie MYŚLI** (4.8 bez ustawienia nie myślał) i pisze dłużej → więcej tokenów na zadanie. Stąd wpis `claude-opus-4-8` na liście. Fable 5 = 2× droższy.
