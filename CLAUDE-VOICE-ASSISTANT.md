...
### ⏭️ DO ZROBIENIA — po stronie użytkownika
- [ ] **Windows: zainstalować 1.0.13 RĘCZNIE raz** ze strony pobierania (`Setup.exe`) — bo
      zainstalowana 1.0.12 ma zepsuty terminal i to pierwsze wydanie Windows ze sprawnym
      mechanizmem. **Self-update Windows zweryfikuje się dopiero przy 1.0.14** (pierwszy realny test).
- [ ] **macOS** zaktualizuje się sam 1.0.12→1.0.13 (mechanizm sprawdzony).
- [ ] Diagnostyczne logi/workflow są nieinwazyjne (gated), mogą zostać; `qflag.log` już nie pisany.
