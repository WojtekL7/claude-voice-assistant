...
- 🆕 **KLIENCKI self-update 1.0.27 → 1.0.28 (okazja, jakiej długo nie było).** Kanał przełączony 2026-08-07; to PIERWSZY raz, gdy zainstalowane paczki 1.0.27 na 3 systemach mają realną aktualizację do pobrania. Ten odcinek („feed → pobierz → podmień → wstań") jest jedyną częścią pipeline'u NIGDY niepotwierdzoną u klienta — jeśli user ma gdzieś zainstalowaną 1.0.27, niech pozwoli jej się zaktualizować i powie, czy wstała jako 1.0.28. Cofnięcie kanału: `cp appcast.json.bak-1.0.27 appcast.json` na VPS.
